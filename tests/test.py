...
def _check_response(r):
    ...
    assert .18 > json['predictions'][0]['detection_box'][1] > .12
    assert .35 > json['predictions'][0]['detection_box'][0] > .25
    assert .60 > json['predictions'][0]['detection_box'][3] > .52
    assert .70 > json['predictions'][0]['detection_box'][2] > .58
